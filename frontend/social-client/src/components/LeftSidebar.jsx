...
export default function LeftSidebar() {
  return (
    <aside className="w-64 bg-white h-screen sticky top-14 p-4 flex flex-col border-r border-gray-200">
      ...
      {/* New Post button */}
      <button className="mt-4 bg-black text-white py-2.5 rounded-lg font-medium text-sm">
        New Post
      </button>
    </aside>
  );
